 ...
 * @{ */
    ...
    namespace table {
         ...
         */
        template<class T>
        __host__ void make(table_t<T>** table, int32_t n, int32_t m);
         ...
         */
        template<class T>
        __device__ __host__ void print(table_t<T>* table);
         ...
         */ 
        template<class T>
        __host__ void destroy(table_t<T>* t);
    ...
    ********************************************************************************/
    ...
    namespace cudatable {
         ...
         */
        template<class T>
        __host__ void transfer_from_gpu(table::table_t<T>** table, table_t<T>* table_d);
         ...
         */
        template<class T>
        __host__ void transfer_to_gpu(table_t<T>** table_d, table::table_t<T>* table);
         ...
         */
        template<class T>
        __host__ void destroy(table_t<T>* table);        
...
template <class T>
__host__ void set_table_values(table::table_t<T>* table, int32_t n, int32_t m, T val);
...
template <class T>
__device__ __host__ void table::print(table::table_t<T>* table) {

 ...
 * @{ */
    ...
    namespace steiner {
         ...
         */
        void fill(graph::graph_t* graph, query::query_t* terminals, table::table_t<float>* distances, result_t** result);
         ...
         * @param [out] result The address of a pointer to the result object of the steiner tree computation.
         */
        void fill(cudagraph::graph_t* graph, cudaquery::query_t* terminals, cudatable::table_t<float>* distances, result_t** result);
